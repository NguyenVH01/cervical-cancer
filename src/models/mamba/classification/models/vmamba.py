...
class DANN(nn.Module):
    def __init__(self, pre_train = False, opt = None):
        ...
        del self.feature_extrator.classifier
        #########################################
        #
        # Label Classifier
        #
        ...
        self.class_classifier.add_module('c_fc1', nn.Linear(self.feature_extrator.num_features, 100))
        ...
        self.class_classifier.add_module('c_fc3', nn.Linear(100, self.opt.num_classes))
        #########################################
        #
        # Domain Classifier
        #
        ...
        self.domain_classifier.add_module('d_fc1', nn.Linear(self.feature_extrator.num_features, 1024))
