...
class VSSM_Adaptation(nn.Module):
    def __init__(
        self, 
        patch_size=4, 
        in_chans=3, 
        ...
        **kwargs,
        ...
        self.classifier = nn.Sequential(OrderedDict(
            ...
            avgpool=nn.AdaptiveAvgPool2d(1),
            flatten=nn.Flatten(1),
            head=nn.Linear(self.num_features, self.num_classes),
        ))
        ...
        self.domain_classifier = nn.Sequential(OrderedDict(
            ...
            avgpool=nn.AdaptiveAvgPool2d(1),
            flatten=nn.Flatten(1),
            d_fc1=nn.Linear(self.num_features, 100),
            d_bn1=nn.BatchNorm1d(100),
            d_relu1=nn.ReLU(True),
            d_fc2=nn.Linear(100, self.domain_classes),
